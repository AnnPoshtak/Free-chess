...
const Settings: React.FC<Props> = ({ isOpen, onClose, onSettingsChange }) => {
  ...
  const updateSetting = <K extends keyof ChessSettings>(
    key: K,
    value: ChessSettings[K],
  ) => {
      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.settingRow}>
          ...
          <select
            ...
            onChange={(e) =>
              updateSetting("theme", e.target.value as ChessSettings["theme"])
            }
          >
        ...
        <div className={styles.settingRow}>
          ...
          <select
            ...
            onChange={(e) =>
              updateSetting(
                "pieceStyle",
                e.target.value as ChessSettings["pieceStyle"],
              )
            }
          >
        ...
        <div className={styles.settingRow}>
          ...
          <select
            ...
            onChange={(e) =>
              updateSetting(
                "difficulty",
                e.target.value as ChessSettings["difficulty"],
              )
            }
          >
        ...
        <div className={styles.settingRow}>
          ...
          <label className={styles.switch}>
            <input
              ...
              onChange={(e) =>
                updateSetting("showAvailableMoves", e.target.checked)
              }
            />
            <span className={styles.slider}></span>
          </label>
        ...
        <div className={styles.settingRow}>
          ...
          <label className={styles.switch}>
            <input
              ...
              onChange={(e) =>
                updateSetting("showMoveHistory", e.target.checked)
              }
            />
            <span className={styles.slider}></span>
          </label>
